        ...
        <footer class="h-auto bg-slate-900 flex justify-center text-slate-600">
            <div class="container py-8 flex">
                ...
                <div class="basis-1/4 flex gap-4">
                    <img src="<?php echo e(asset('assets/images/logo-unmul.png')); ?>" alt="Logo Universitas Mulawarman" class="h-20">
                    <img src="<?php echo e(asset('assets/images/logo-informatika.png')); ?>" alt="Logo Program Studi Informatika" class="h-20">
                </div>
