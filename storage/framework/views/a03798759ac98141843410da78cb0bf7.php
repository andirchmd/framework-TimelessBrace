...
<section class="h-[400px] flex flex-col">
    ...
    <div class="h h-2/3 flex flex-row">
        ...
        <div class="basis-1/4 bg-blue-800 relative flex justify-center items-center">
            <svg class="h-4/5 w-full opacity-20 absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
...
<?php /**PATH C:\xampp\htdocs\TimelessBrace\resources\views/components/statistik.blade.php ENDPATH**/ ?>